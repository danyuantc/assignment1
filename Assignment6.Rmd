...
date: "11/16/2016 Dan Yuan assignment6"
...
c.tree1 <- rpart(factor(certified) ~ grade + forum.posts + assignment, method="class", data = M1, control = rpart.control(minsplit = 10, cp = .001))
...
post(c.tree1, file = "tree.ps", title = "Certification results")
...
(1792+1196)/(288+1792+1196+6724) # == .2988

(206+2021)/(59+2021+206+7714)   # == .2227
```
